...
def init_chess_detection(self, capture_index):
    ...
    self.model = self.load_model("/media/peter-bui/E/Chess-voice-recognition/weights/pavel_moveside.pt")
    self.board_model = self.load_model("/media/peter-bui/E/Chess-voice-recognition/weights/board_flip_detect.pt")
